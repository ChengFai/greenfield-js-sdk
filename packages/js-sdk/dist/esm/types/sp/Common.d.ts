...
export declare function formatBucketInfo(o: BucketInfo): BucketInfo;
export declare function formatObjectInfo(o: ObjectInfo): ObjectInfo;
...
export declare function formatGroupInfo(o: GroupInfo): GroupInfo;
