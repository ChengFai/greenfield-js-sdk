...
// prettier-ignore
const _0n$2 = BigInt(0), _1n$4 = BigInt(1); BigInt(2); const _3n = BigInt(3); BigInt(4);
...
// prettier-ignore
BigInt(0); const _1n$1 = BigInt(1), _2n$1 = BigInt(2), _5n = BigInt(5);
// prettier-ignore
...
Fp.pow(_2n$1, ELL2_C1); // 2. c2 = 2^c1
Fp.sqrt(Fp.neg(Fp.ONE)); // 3. c3 = sqrt(-1)
(Fp.ORDER - BigInt(5)) / BigInt(8); // 4. c4 = (q - 5) / 8       # Integer arithmetic
BigInt(486662);
...
const getApprovalMetaInfo = (endpoint, action, msg) => {
    ...
    const unSignedMessageInHex = bytesToHex$1(utf8ToBytes$1(JSON.stringify(msg)));
    const reqMeta = {
